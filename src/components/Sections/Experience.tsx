...
const experienceData: ExperienceItem[] = [
  {
    ...
    technologies: [
      ".NET", "ReactJS", "MariaDB", "MongoDB", "Microservices", 
      "NATS Jetstream", "EventStore", "Akka.NET", "gRPC"
    ],
    achievements: [
  ...
  },
  {
    ...
    technologies: [
      ".NET", "Azure Cloud", "MySQL", "CosmosDB"
    ],
    achievements: [
  ...
  },
  {
    ...
    technologies: [
      ".NET", "JavaScript", "KendoUI", "MS SQL Server", "Microservices"
    ],
    achievements: [
  ...
  },
  {
    ...
    technologies: [
      ".NET", "JavaScript", "AngularJS", "MS SQL Server", "Sitecore"
    ],
    achievements: [
  ...
  },
  {
    ...
    achievements: [
      "Working as a Key member",
      "Learned Sitecore CMS"
    ]
  }
];
  ...
  return (
    <section id="experience" className="py-20 bg-gray-800">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-8 text-center text-teal-400">Professional Experience</h2>
          ...
          {experienceData.map((experience, index) => (
            ...
            >
              <div className="flex flex-col items-center text-center gap-2 mb-4">
                <h3 className="text-2xl font-semibold text-teal-400">{experience.company}</h3>
                <span className="text-gray-400">{experience.period}</span>
                <span className="font-medium text-teal-300">{experience.position}</span>
              </div>

              <div className="space-y-4 text-left">
                <div>
                  <h4 className="font-medium mb-2 text-teal-400">Main Responsibilities:</h4>
                ...
                <div>
                  <h4 className="font-medium mb-2 text-teal-400">Technologies:</h4>
                ...
                <div>
                  <h4 className="font-medium mb-2 text-teal-400">Key Achievements:</h4>
                  <ul className="list-disc list-inside space-y-1">
